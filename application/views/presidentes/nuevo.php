...
<form class="" action="<?php echo site_url(); ?>/presidentes/guardar" method="post">
  ...
  <div class="row">
    <div class="col-md-4">
      ...
      <br>
      <input type="doble" class="form-control" name="ci_pres" value="" id="ci_pres" placeholder="Ingrese identificación">
      </div>
  </div>
      <div class="row">
        <div class="col-md-3">
  ...
  <div class="row">
    <div class="col-md-4">
      ...
      <br>
      <select type="text" class="form-control" name="provincia_pres" id="provincia_pres" class="form-control input-sm" required>
  ...
  <div class="row">
    <div class="col-md-3">
      ...
      <br>
      <input type="float" class="form-control" name="latitud_pres" value="" id="latitud_pres" placeholder="Ingrese latitud">
    </div>
    <div class="col-md-3">
      <label for="">Longigtud:</label>
      <br>
      <input type="float" class="form-control" name="longitud_pres" value="" id="longitud_pres" placeholder="Ingrese longitud">
    </div>
    <div class="col-md-3">
      <label for="">Tipo de Posisicon politica:</label>
      <br>
      <select type="text" class="form-control" name="posicion_pres" id="posicion_pres" class="form-control input-sm" required>
